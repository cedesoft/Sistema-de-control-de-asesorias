...
<div class="container">
                ...
                <div class="mb-3 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="" class="open-Cancelar card-link" data-id="{!! $item->id !!}"
                                data-name="{!! $item->nom_materia !!}" data-toggle="modal"
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">{!! $item->nom_alumno !!}</h5>
                                <p class="card-text">Solicitud de una asesoria para el tema de <strong>{!!
                                        $item->tema!!}</strong>
                                ...
                                <a href="" class="btn btn-danger open-Cancel" data-id="{!! $item->id !!}"
                                    data-name="{!! $item->nom_materia !!}" data-toggle="modal"
                                    data-target="#exampleModalCancel">Cancelar</a>
                            </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <a href="" class="btn btn-success open-Aceptar" data-id="{!! $item->id !!}"
                                    ...
                                    data-materia="{!! $item->nom_materia !!}" data-docente="{!! $item->nom_docente !!}"
                                    data-fecha=" {!! $item->fechaSolicitud !!}" data-unidad="{!! $item->unidad !!}"
                                    data-tema="{!! $item->tema !!}" data-toggle="modal"
                                    data-target="#exampleModalCenter">Confirmar</a>
                            </div>
                            <div class="card-footer text-muted">
                                {!! $item->fechaSolicitud !!}
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Confirmar de Asesoría</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="POST" action="{{ route('confirmar') }}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="fecha_realizacion" name="fecha_realizacion"
                                placeholder="Fecha para iniciar asesorias">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="fecha_terminacion" name="fecha_terminacion"
                                placeholder="Fecha para terminar asesorias">
                        </div>
    ...
    <div>
        <!-- Modal -->
        <div class="modal fade" id="ModalCancelar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        <form action="{{ route('cancelAsesoriaDocente') }}" method="POST" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            <input type="text" class="d-none" id="id" name="id">
        ...
        <div class="modal fade" id="ModalDetalles" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('actualizarAsesoriaDocente') }}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="fecha_terminacion" value="2020/05/05"
                                    name="fecha_terminacion" placeholder="Fecha para terminar asesorias">
                            </div>
                            <div class="form-group">
                                <label id="l" for="hora"><b>Lugar</b></label>
                                <input type="text" class="form-control" id="lugar" name="lugar"
        ...
        <div class="modal fade" id="exampleModalCancel" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form action="{{ route('cancelDocente') }}" method="POST" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            <input type="text" class="d-none" id="id" name="id">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                            <button type="submit" class="btn btn-primary">Eliminar</button>
...
<script>
    $(document).on("click", ".open-Aceptar", function () {
        ...
        $(".modal-body #fecha_solicitud").val(fecha);
    ...
    $(document).on("click", ".open-Cancelar", function () {
        var id = $(this).data('id');
        var nombre = $(this).data('name');
        $(".modal-body #id_text").text(nombre);
        $(".modal-footer #id").val(id);
