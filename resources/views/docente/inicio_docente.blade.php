    ...
    <div class="row">
        <div class="contenedorr">
            <div class="carta">
                ...
                <div class="lado atras">
                    <div class="card">
                        <div class="card-header" style="background-image: url({!! asset('assets/Images/materias.png') !!})">
        ...
        <div class="contenedorr">
            <div class="carta">
                ...
                <div class="lado atras">
                    <div class="card">
                        <div class="card-header" style="background-image: url({!! asset('assets/Images/historial.png') !!})">
                            <div class="card-header-slanted-edge">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 200">
                                    <path class="polygon" d="M-20,200,1000,0V200Z" /></svg>
                                <a href="#" class="btn-follow"><span class="sr-only">Ir</span></a>
