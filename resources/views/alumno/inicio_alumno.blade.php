                    ...
                    <div class="card">
                        <div class="card-header"
                            ...
                            <div class="card-header-slanted-edge">
                                ...
                                <a href="{{url('alumno/docentes')}}" class="btn-follow"><span class="sr-only">Ir</span></a>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header"
                            ...
                            <div class="card-header-slanted-edge">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 200">
                                    <path class="polygon" d="M-20,200,1000,0V200Z" /></svg>
                                <a href="{{url('alumno/materias')}}" class="btn-follow"><span class="sr-only">Ir</span></a>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header"
                            ...
                            <div class="card-header-slanted-edge">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 200">
                                    <path class="polygon" d="M-20,200,1000,0V200Z" /></svg>
                                <a href="{{url('asesorias/alumno')}}" class="btn-follow"><span class="sr-only">Ir</span></a>
                            </div>
                        </div>
                        <div class="card-body">
